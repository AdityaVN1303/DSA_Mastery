...
// Approach 1 - Using GCD Function from STL
// TC - O(n + log(min(a , b)))
// SC - O(1)

// Approach 2 - Descending Common Divisor Search (BRUTE)
// TC - O(n + min(a , b)))
// SC - O(1)
...
// Approach 3 - Using Euclidean Algorithm(Subtraction Version)
// TC - O(n + (max(a , b)))
// SC - O(1)
...
// Approach 4 - Using Euclidean Algorithm(Modulus Version) (OPTIMAL)
// TC - O(n + log(min(a , b)))
// SC - O(1)
